...
public class Bathulhu extends Mammal {
	...
	public void fly() {
		...
		// But if they did, it would be: energy -= 50;
		...
		System.out.println("You attempt to scream, but your mouth remains still.\n");
	}
	
	public int eatHumans() {
		System.out.println("As you gaze into what appears to be an indescribable black abyss, you realize, all too late, that it is the maw of a cosmic horror...");
		System.out.println("You hear the call of Bathulu one last time... Darkness envelopes you.\n");
	...
	public int attackTown() {
		...
		// Eldritch horrors do not weaken, but if they did, it would be: energy -= 100;
